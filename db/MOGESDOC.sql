...
ALTER TABLE MOGESDOC.MUNICIPIO ADD CONSTRAINT REL_DEPARTAMENTO FOREIGN KEY (DEPARTAMENTO) REFERENCES MOGESDOC.DEPARTAMENTO (ID) ON UPDATE Cascade ON DELETE Cascade;
ALTER TABLE MOGESDOC.AGENCIA ADD CONSTRAINT REL_MUNICIPIO_AGENCIA FOREIGN KEY (MUNICIPIO) REFERENCES MOGESDOC.MUNICIPIO (ID) ON UPDATE No action ON DELETE No action;
